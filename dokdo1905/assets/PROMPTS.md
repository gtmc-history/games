...
| `scene-s4.jpg` | AI 삽화 적용 (2026-09-24) | 깃발·문장 없음. 갑판의 작은 실루엣은 얼굴 식별 불가 수준(허용 범위) |
| `scene-s5.jpg` | AI 삽화 적용 (2026-09-24) | 사람 없음, 정박한 윤선·초가·고깃배 |
| `scene-s6.jpg` | AI 삽화 적용 (2026-09-24) | 좌우 벽화의 배·누각·처마가 중국풍에 가까움 — 재생성 고려(선택) |
| `yoon.jpg` | AI 삽화 적용 (2026-09-24) | 가공 인물. 16:9 원본을 얼굴 중심 정사각형으로 자름. 실존 인물과 닮았는지 교사 확인 |
